...
<script src="https://cdnjs.cloudflare.com/ajax/libs/overlayscrollbars/1.10.1/js/jquery.overlayScrollbars.min.js"
    integrity="sha512-mW1qcxit+Dfx3MTRynaM/fxr8Bu2tmnYaWlXgU3slnjSrf5XRs7Mw3ErH0Ntm6TT+uf5/Qn8FuTsLt5Kj8qzJQ=="
    crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<!-- AdminLTE App -->
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/datatables.net-responsive-bs4/3.0.2/responsive.bootstrap4.min.js"
    integrity="sha512-Zzbdl2n6Pntg4bj9eylQeF7M5KM4xzBah2YGAGdH8m2R+EDkVk0Ih0p4shjN9UlM6Mts4vbTzWLyuoiiOf+qHw=="
    crossorigin="anonymous" referrerpolicy="no-referrer"></script>
{{-- <script src="{{ asset('AdminLTE/plugins/datatables-buttons/js/dataTables.buttons.min.js') }}"></script> --}}
<script src="https://cdnjs.cloudflare.com/ajax/libs/datatables-buttons/3.0.2/js/dataTables.buttons.min.js"
    integrity="sha512-14shWK3qFVtqjfVywWUNuBNHxcEeS/3pJb9Lfj08z1/Y6mbMj9Ye4GOmiYnMbodUCNleopnrWldy92leOSkgpg=="
    crossorigin="anonymous" referrerpolicy="no-referrer"></script>
{{-- <script src="{{ asset('AdminLTE/plugins/datatables-buttons/js/buttons.bootstrap4.min.js') }}"></script> --}}
<script src="https://cdnjs.cloudflare.com/ajax/libs/datatables.net-buttons-bs4/3.0.2/buttons.bootstrap4.min.js"
    integrity="sha512-NIgR+Z5K5z+p6jhlK+NfbG25zKiWKrAmkwcVePpYfT03gu38BYYYS7P5hk61hX6fJKFlgbvrg5sGEgmA1f8DyA=="
    crossorigin="anonymous" referrerpolicy="no-referrer"></script>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/datatables-buttons/3.0.2/js/buttons.html5.min.js"
    integrity="sha512-Z5ncChk5bjNiHAmrl+5Fi8VKJBbBGG/201yHhc/rHEnElgkwVEHklcDIJ9ZCjxP4YoS1FA8KN0bsx3r6V8uMbA=="
    crossorigin="anonymous" referrerpolicy="no-referrer"></script>
{{-- <script src="{{ asset('AdminLTE/plugins/datatables-buttons/js/buttons.print.min.js') }}"></script> --}}
<script src="https://cdnjs.cloudflare.com/ajax/libs/datatables-buttons/3.0.2/js/buttons.print.min.js"
    integrity="sha512-G5WOQtCr4Qiu9ggzRYYGIozuZ5yJOsl2s58tRyTZXLMmPZilft/jSJIZRBgi+7cHAwpquNT0QRE7OrJ03wIauA=="
    crossorigin="anonymous" referrerpolicy="no-referrer"></script>
{{-- <script src="{{ asset('AdminLTE/plugins/datatables-buttons/js/buttons.colVis.min.js') }}"></script> --}}
<script src="https://cdnjs.cloudflare.com/ajax/libs/datatables-buttons/3.0.2/js/buttons.colVis.min.js"
    integrity="sha512-Aco2AZMfg/w1xDL6ym1XZa0ghs/l66pUEOmmhQJ0Pd5BmgDgNWUncB1wyUO6dRm7MDf5WvO7AhKGtBfb+sYmgg=="
    crossorigin="anonymous" referrerpolicy="no-referrer"></script>
